...
(function () {
    ...
    let styles_script = 'https://betterbetgroup.github.io/mobile_oddsmatch/desktop_oddsmatchers/each_way_oddsmatcher/styles.css';
    ...
    class eachWayOddsmatcher extends HTMLElement {
        ...
        constructor() {
            ...
            this.state = {
                ...
                is_desktop: true,
                desktop_header_columns: ['date and time', 'race', 'horse', 'each way back bet', 'win lay bet', 'place lay bet', 'profit', 'rating']
