...
(function () {
    ...
    class sequentialLayCalculator extends HTMLElement {
        ...
        constructor() {
            ...
            this.state = {
                ...
                local_calc_data: {},
                data_object: {},
                calculator_type: 'Sequential Lay',
            };
    ...
    customElements.define('sequential-lay-calculator', sequentialLayCalculator);
