...
(function () {
    ...
    let styles_script = 'https://betterbetgroup.github.io/mobile_oddsmatch/calculators/odds_converter/styles.css';





    class oddsConverter extends HTMLElement {
        ...
        constructor() {
            ...
            this.state = {
                ...
                local_calc_data: {},
                data_object: {},
                calculator_type: 'Odds Converter',
            };
    ...
    customElements.define('odds-converter', oddsConverter);
